...
def train_model(model, X_train, y_train, X_test, y_test):
    history = model.fit(X_train, y_train, verbose=1, epochs=3000, batch_size=128,
...
def plot_results(results):
    ...
    plt.xlim(80, 100)  # Set xlim to show from 80% to 100%
...
def main():
    ...
    while True:
        ...
        print("11. Evaluate Classifiers with Cross-Validation")
        print("12. Exit")
        ...
        if choice == "1":
            ...
            if 'X_train' not in locals() or 'y_train' not in locals():
                print("Please split data first.")
                continue
            results = evaluate_classifiers(X_train, y_train)
